...
* *Similar Questions:*
  ...
  * [IP to CIDR](./tests/validate-ip-address.md)
...
public:
    string validIPAddress(string IP) {
        regex ipv4Reg("((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])");
        regex ipv6Reg("(([0-9a-fA-F]){1,4}:){7}([0-9a-fA-F]){1,4}");
        if (regex_match(IP, ipv4Reg))   return "IPv4";
        if (regex_match(IP, ipv6Reg))   return "IPv6";
        return "Neither";
    }
};
```
